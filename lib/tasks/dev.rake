...
namespace :dev do
  ...
  task add_articles: :environment do
    show_spinner("Iniciando o cadastro de Artigos!", "Artigos adicionados!") { add_articles }
  end

  desc "Add users to the database"
  task add_users: :environment do
    show_spinner("Iniciando o cadastro de usuarios!", "Usuarios adicionados!") { add_users }
  end

  desc "Add comments to the database"
  task add_comments: :environment do
    show_spinner("Iniciando o cadastro de comentarios!", "Comentarios adicionados!") { add_comments }
  end
